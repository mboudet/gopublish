...
Revision ID: a74da9a0ce76
Revises: 
Create Date: 2022-01-21 14:10:44.210339
...
def upgrade():
    ...
    sa.Column('version_of_id', postgresql.UUID(as_uuid=True), nullable=True),
    ...
    sa.ForeignKeyConstraint(['version_of_id'], ['published_file.id'], ),
